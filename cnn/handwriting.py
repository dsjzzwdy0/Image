...
# 定义神经网络模型的评估部分
def compute_accuracy(sess, prediction, xs, test_xs, test_ys, keep_prob):
    # 获得预测值y_pre
...
print("Load MNIST data spend time is ", (end - start), "s.")
...
def create_l6_net():
    ...
    return xs, ys, keep_prob, train_step, prediction
